        ...
        <>
            <div className="flex flex-row justify-items-center gap-6 ml-5">
                ...
                <div className="relative bg-[#D8E3F2] p-15 rounded-lg shadow-lg w-[405px] h-[251px]">
                    ...
                    <h2 className="font-bold text-black-600 text-3xl w-1/2 p-1">Novo drop Supreme</h2>
                    <button className="bg-[#F5F5F5] rounded-md p-3 font-bold text-[#C92071]" >Comprar</button>
                ...
                <div className="relative bg-[#D8E3F2] p-10 rounded-lg shadow-lg w-[405px] h-[251px]">
                    <button className="bg-[#E7FF86] font-bold rounded-xl p-1">30% Off</button>
                    <h2 className="font-bold text-black-600 text-3xl w-1/2">Coleção Adidas</h2>
                    <button className="bg-[#F5F5F5] rounded-md p-3 font-bold text-[#C92071]" >Comprar</button>
                ...
                <div className="relative bg-[#D8E3F2] p-10 rounded-lg shadow-lg w-[405px] h-[251px]">
                    <button className="bg-[#E7FF86] font-bold rounded-xl p-1">30% Off</button>
                    <h2 className="font-bold text-black-600 text-3xl w-1/2">Novo Beat Bass</h2>
                    <button className="bg-[#F5F5F5] rounded-md p-3 font-bold text-[#C92071]">Comprar</button>
