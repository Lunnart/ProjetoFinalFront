      ...
      <nav className="flex gap-10">
        <div className="w-[150px]">
          ...
          <ul className=" text-white pt-5 leading-[38px]">
            <li><a className="hover:underline hover:text-primary text-white" href="">Sobre Drip Store</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Segurança</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Wishlist</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Blog</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Trabalhe Conosco</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Meus Pedidos</a></li>
          </ul>
        </div>
        <div className="px-10">
          <h2 className=" font-semibold  text-white ">Categorias</h2>
          <ul className=" text-white pt-5 leading-[38px]">
            <li><a className="hover:underline hover:text-primary text-white" href="">Camisetas</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Calças</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Bonés</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Headphones</a></li>
            <li><a className="hover:underline hover:text-primary text-white" href="">Ténis</a></li>
          </ul>
        </div>
   
      <div className="px-5 w-[300px] ml-[120px]">
